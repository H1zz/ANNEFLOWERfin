...
let img_array = ['img/items/kirby.png','img/items/kirby.png','img/items/kirby.png','img/items/kirby.png','img/items/kirby.png','img/items/kirby.png','img/items/kirby.png','img/items/kirby.png','img/banner/010.jpg'];
...
Name(9);
function Name(n){
    let Name = ["KIRBY1","KIRBY2","KIRBY3","KIRBY4","KIRBY5","KIRBY6","KIRBY7","KIRBY8","INU"];
    for(let i =0;i<n;i++){
